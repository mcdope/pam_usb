...
* **Integration Tests:** Functional/integration tests—like those already in `tests/can-actually-be-used`—**must** be created for new features. If no integration test is feasible (e.g., the change is purely internal refactoring or documentation-only), explain why in the PR description.
...
* **PR Descriptions (Reasoning):** PR descriptions **must** include a brief summary of *why* a specific technical approach was chosen, unless the change is trivially self-explanatory.
